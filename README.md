...
## Downloads:
* Latest Windows stable version v33 (this file contain all the config files): [mpv.snad](https://github.com/thisisshihan/mpv.snad/raw/master/mpv-0.33.0-x86_64.7z) _(2020-12-06)_
#### How to install:
* Extract the files.
