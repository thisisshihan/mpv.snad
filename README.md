...
## Downloads:
* Latest Windows stable version v30 (2019-11-02) (this file contain all the config files): [mpv.snad](https://github.com/thisisshihan/mpv.snad/raw/master/mpv-0.30.0-x86_64.rar)
#### How to install:
* Extract the files.
